...
\NormalTok{title }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\FunctionTok{ncatt\_get}\NormalTok{(nc, }\StringTok{"gwr"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{long\_name, }\StringTok{" \#"}\NormalTok{, month)}
\NormalTok{xlab }\OtherTok{\textless{}{-}} \FunctionTok{ncatt\_get}\NormalTok{(nc, }\StringTok{"lat"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{long\_name}
\NormalTok{ylab }\OtherTok{\textless{}{-}} \FunctionTok{ncatt\_get}\NormalTok{(nc, }\StringTok{"lon"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{long\_name}
