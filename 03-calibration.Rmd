...
We will start by defining a simulation and quality evaluation function: the returned values will be used by `caRamel` to measure the quality of the injected parameters.
